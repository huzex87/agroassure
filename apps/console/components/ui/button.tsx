...
// shadcn/ui button, with two variants this product needs that the registry
// does not ship: success and warning. Status in this console is a vocabulary,
// not a decoration, and a control that closes a finding should be able to speak
// it the same way the badge beside it does.
